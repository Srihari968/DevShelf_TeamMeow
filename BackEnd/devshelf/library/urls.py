...
from .views import HomePage, testPage, get_name,borrow_page, my_borrows, view_borrow_reqs, lend_book, receive_book
...
urlpatterns =[
    ...
    path('receive_book/', receive_book, name = 'receive_book')
]